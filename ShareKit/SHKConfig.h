...
#define SHKMyAppName			@"SnookerScoreboard"
#define SHKMyAppURL				@"http://itunes.apple.com/md/app/snooker-scoreboard-touch/id493874540"
...
#define SHKFacebookKey				@"281033741945478"
#define SHKFacebookSecret			@"75d6d287c55524ca1dccfaa99a28cbfb"
 ...
 */
#define SHKTwitterConsumerKey		@"XiqsDKkz4dQ5LPsxhPN5ug"
#define SHKTwitterSecret			@"q8g1mFbwam0sdx85HzqdiDWIu3c7ABrESAGLb0ZM4"
#define SHKTwitterCallbackUrl		@"http://www.joyqom.com/twitteroauth" // You need to set this if using OAuth, see note above (xAuth users can skip it)
